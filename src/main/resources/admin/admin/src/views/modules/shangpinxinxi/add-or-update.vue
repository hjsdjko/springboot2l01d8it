	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="新旧程度" prop="xinjiuchengdu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="新旧程度" prop="xinjiuchengdu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="商品介绍" prop="shangpinjieshao">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.shangpinjieshao" label="商品介绍" prop="shangpinjieshao">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../springboot2l01d8it/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
