	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="成色要求" prop="chengseyaoqiu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="成色要求" prop="chengseyaoqiu">
					<el-input v-model="ruleForm.chengseyaoqiu"
						placeholder="成色要求" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="接受价位" prop="jieshoujiawei">
					<el-input v-model="ruleForm.jieshoujiawei" placeholder="接受价位" clearable  :readonly="ro.jieshoujiawei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="接受价位" prop="jieshoujiawei">
					<el-input v-model="ruleForm.jieshoujiawei" placeholder="接受价位" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="需求数量" prop="xuqiushuliang">
					<el-input v-model.number="ruleForm.xuqiushuliang" placeholder="需求数量" clearable  :readonly="ro.xuqiushuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="需求数量" prop="xuqiushuliang">
					<el-input v-model="ruleForm.xuqiushuliang" placeholder="需求数量" readonly></el-input>
				</el-form-item>
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `qiugoushangpin/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.qiugoushangpinCrossAddOrUpdateFlag = false;
											this.parent.search();
