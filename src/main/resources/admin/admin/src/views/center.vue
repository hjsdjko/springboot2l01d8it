  ...
  <div :style='{"color":"#666","padding":"0px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="学号" prop="xuehao">
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.mima)&& 'yonghu'==this.flag){
        ...
        if(this.ruleForm.mima && ((this.ruleForm.mima).toString().length<6) && `yonghu` == this.flag){
            this.$message.error(`密码长度不能小于6`);
            return
        }

        if(this.ruleForm.mima && ((this.ruleForm.mima).toString().length>12) && `yonghu` == this.flag){
