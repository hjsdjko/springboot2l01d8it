	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"24px 12% 0","borderColor":"#eee","alignItems":"flex-start","color":"#999","textAlign":"right","display":"block","justifyContent":"flex-end","top":"0","left":"0","background":"#f5f5f5","borderWidth":"0px","width":"100%","fontSize":"16px","position":"relative","borderStyle":"solid","height":"100px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","overflow":"hidden","top":"100px","background":"none","display":"block","width":"24%","position":"absolute","float":"left","height":"72px"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","overflow":"hidden","color":"#fff","alignItems":"center","background":"none","display":"flex","width":"100%","lineHeight":"32px","fontSize":"20px","float":"left","fontWeight":"500","height":"100%"}'>基于JAVA的校园二手物品交易系统的设计与实现</span>
			</div>
			...
			<div :style='{"cursor":"pointer","padding":"0 10px 0 0","color":"inherit","display":"inline-block","fontSize":"inherit","lineHeight":"32px","height":"32px"}' @click="goBackend">后台管理</div>
        ...
        <el-dialog title="留言反馈" :visible.sync="chatFormVisible" width="600px" :before-close="chatClose">
