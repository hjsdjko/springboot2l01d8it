...
<div id="animate_recommendshangpinxinxi" class="recommend animate__animated" :style='{"padding":"60px 0 60px","margin":"40px auto 20px","borderColor":"#ddd","background":"#f1f1f1","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
    ...
    <div class="title" :style='{"width":"76%","padding":"45px 0 0","margin":"0px auto","textAlign":"left","background":"url() no-repeat left top / auto 42px","height":"120px"}'>
		<span :style='{"padding":"0","fontSize":"32px","color":"#000","fontWeight":"600","display":"block"}'>商品信息推荐</span>
	</div>
		  ...
		  <div v-for="item,index in shangpinxinxiRecommend" :key="index"  @click="toDetail('shangpinxinxiDetail', item)" class="list-item animation-box">
		    ...
		    <div :style='{"width":"100%","padding":"0","overflow":"hidden","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"100%","padding":"0 0 10px","flexWrap":"wrap","display":"flex"}'>
				...
				<div class="title">{{item.shangpinfenlei}}</div>
				<div class="title">新旧程度:{{item.xinjiuchengdu}}</div>
...
<!-- 商品推荐 -->
<div id="animate_recommendqiugoushangpin" class="recommend animate__animated" :style='{"padding":"60px 0 60px","margin":"40px auto 20px","borderColor":"#ddd","background":"#f1f1f1","borderWidth":"0px 0","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
	<div v-if="false" class="idea recommendIdea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
    ...
    <div class="title" :style='{"width":"76%","padding":"45px 0 0","margin":"0px auto","textAlign":"left","background":"url() no-repeat left top / auto 42px","height":"120px"}'>
		<span :style='{"padding":"0","fontSize":"32px","color":"#000","fontWeight":"600","display":"block"}'>求购商品推荐</span>
	</div>
		...
		<div v-if="qiugoushangpinRecommend.length" class="list list16 index-pv1" :style='{"padding":"0 12%","margin":"20px 0 0","color":"#999","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"space-between","height":"auto"}'>
		  <div v-for="item,index in qiugoushangpinRecommend" :key="index"  @click="toDetail('qiugoushangpinDetail', item)" class="list-item animation-box">
		    <div :style='{"border":"0px solid red","width":"100%","padding":"0px","overflow":"hidden","height":"320px"}' class="img-box">
				<img class="image" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
				<img class="image" :style='{"width":"100%","objectFit":"cover","display":"block","height":"100%"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
			</div>
		    <div :style='{"width":"100%","padding":"0","overflow":"hidden","display":"flex","height":"auto"}' class="item-info">
		      <div :style='{"width":"100%","padding":"0 0 10px","flexWrap":"wrap","display":"flex"}'>
				<div class="title">{{item.shangpinmingcheng}}</div>
				<div class="title">{{item.shangpinfenlei}}</div>
				<div class="title">{{item.chengseyaoqiu}}</div>
		        <div :style='{"padding":"0 10px","borderColor":"red","textAlign":"right","borderWidth":"0","display":"none","width":"100%","lineHeight":"30px","borderStyle":"solid","order":"5"}' class="time">
		          <span class="icon iconfont icon-shijian21"></span>
		          <span class="text">{{item.addtime}}</span>
		        </div>
	...
	<div @click="moreBtn('qiugoushangpin')" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 20px 0 0","margin":"90px -12px 0 0","textAlign":"right","display":"block","right":"12%","top":"0","background":"url(http://codegen.caihongy.cn/20231010/b345185c76ac4a77bf4cd6f6171a72ed.png) no-repeat center top / 100% 100%","width":"240px","lineHeight":"73px","position":"absolute","height":"80px"}'>
		<span :style='{"color":"#333","fontSize":"14px"}'>查看更多</span>
		<i :style='{"color":"#333","fontSize":"16px","display":"none"}' class="icon iconfont icon-jiantou09"></i>
	</div>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendqiugoushangpin',css:'animate__'},
      ...
      preHttp(str) {
		...
		getList() {
          ...
          autoSortUrl = "qiugoushangpin/autoSort";
			data = {
				page: 1,
				limit: 8,
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.qiugoushangpinRecommend = res.data.data.list;
